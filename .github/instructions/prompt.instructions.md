...
- Prompt file **must** be kept in english to ensure compatibility with Copilot's language models.
- Document any organization-specific conventions or deviations from these guidelines in a central location for prompt authors.
